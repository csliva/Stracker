      ...
      <div style={{ flex: '1' }}>
          <div className="container card">
            <div className="card-content">
              ...
              <h4 className="is-size-6 has-text-centered"><i className="fa fa-mouse-pointer" aria-hidden="true"></i>Clock In. <i className="fa fa-hand-pointer-o" aria-hidden="true"></i>Clock Out. <i className="fa fa-bar-chart" aria-hidden="true"></i>Analyze and Invoice your time.</h4>
